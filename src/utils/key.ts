  ...
  return [
    ...
    },
    {
      ...
      keycodes: [
        ...
        {name:  'BLE2',code:'BLE2', title:  'BLE2'},
        {name:  'RF 2.4G',code:'RF', title:  'RF'},
        {name:  'USB wireless',code:'USB', title:  'USB'}
      ],
    },
    // dial键
    {
      ...
      width: 'label',
      keycodes: [
        {name: 'Dial L', code: 'DIAL_L', title: 'Dial_L'},
        {name: 'Dial BUT', code: 'DIAL_BUT', title: 'Dial_BUT'},
        {name: 'Dial R',code:'DIAL_R', title: 'Dial_R'},
        {name: 'Dial LC',code:'DIAL_LC', title: 'Dial_LC'},
        {name: 'Dial RC',code:'DIAL_RC', title: 'Dial_RC'}
      ],
    },
    // MIDI键
    {
      ...
      width: 'label',
      keycodes: [
        {name: 'MI_ON', code: 'MI_ON', title: 'MI_ON'},
{name: 'MI_OFF', code: 'MI_OFF', title: 'MI_OFF'},
{name: 'MI_TOG', code: 'MI_TOG', title: 'MI_TOG'},
{name: 'MI_C', code: 'MI_C', title: 'MI_C'},
{name: 'MI_Cs', code: 'MI_Cs', title: 'MI_Cs'},
{name: 'MI_D', code: 'MI_D', title: 'MI_D'},
{name: 'MI_Ds', code: 'MI_Ds', title: 'MI_Ds'},
{name: 'MI_E', code: 'MI_E', title: 'MI_E'},
{name: 'MI_F', code: 'MI_F', title: 'MI_F'},
{name: 'MI_Fs', code: 'MI_Fs', title: 'MI_Fs'},
{name: 'MI_G', code: 'MI_G', title: 'MI_G'},
{name: 'MI_Gs', code: 'MI_Gs', title: 'MI_Gs'},
{name: 'MI_A', code: 'MI_A', title: 'MI_A'},
{name: 'MI_As', code: 'MI_As', title: 'MI_As'},
{name: 'MI_B', code: 'MI_B', title: 'MI_B'},
{name: 'MI_C_1', code: 'MI_C_1', title: 'MI_C_1'},
{name: 'MI_Cs_1', code: 'MI_Cs_1', title: 'MI_Cs_1'},
{name: 'MI_D_1', code: 'MI_D_1', title: 'MI_D_1'},
{name: 'MI_Ds_1', code: 'MI_Ds_1', title: 'MI_Ds_1'},
{name: 'MI_E_1', code: 'MI_E_1', title: 'MI_E_1'},
{name: 'MI_F_1', code: 'MI_F_1', title: 'MI_F_1'},
{name: 'MI_Fs_1', code: 'MI_Fs_1', title: 'MI_Fs_1'},
{name: 'MI_G_1', code: 'MI_G_1', title: 'MI_G_1'},
{name: 'MI_Gs_1', code: 'MI_Gs_1', title: 'MI_Gs_1'},
{name: 'MI_A_1', code: 'MI_A_1', title: 'MI_A_1'},
{name: 'MI_As_1', code: 'MI_As_1', title: 'MI_As_1'},
{name: 'MI_B_1', code: 'MI_B_1', title: 'MI_B_1'},
{name: 'MI_C_2', code: 'MI_C_2', title: 'MI_C_2'},
{name: 'MI_Cs_2', code: 'MI_Cs_2', title: 'MI_Cs_2'},
{name: 'MI_D_2', code: 'MI_D_2', title: 'MI_D_2'},
{name: 'MI_Ds_2', code: 'MI_Ds_2', title: 'MI_Ds_2'},
{name: 'MI_E_2', code: 'MI_E_2', title: 'MI_E_2'},
{name: 'MI_F_2', code: 'MI_F_2', title: 'MI_F_2'},
{name: 'MI_Fs_2', code: 'MI_Fs_2', title: 'MI_Fs_2'},
{name: 'MI_G_2', code: 'MI_G_2', title: 'MI_G_2'},
{name: 'MI_Gs_2', code: 'MI_Gs_2', title: 'MI_Gs_2'},
{name: 'MI_A_2', code: 'MI_A_2', title: 'MI_A_2'},
{name: 'MI_As_2', code: 'MI_As_2', title: 'MI_As_2'},
{name: 'MI_B_2', code: 'MI_B_2', title: 'MI_B_2'},
{name: 'MI_C_3', code: 'MI_C_3', title: 'MI_C_3'},
{name: 'MI_Cs_3', code: 'MI_Cs_3', title: 'MI_Cs_3'},
{name: 'MI_D_3', code: 'MI_D_3', title: 'MI_D_3'},
{name: 'MI_Ds_3', code: 'MI_Ds_3', title: 'MI_Ds_3'},
{name: 'MI_E_3', code: 'MI_E_3', title: 'MI_E_3'},
{name: 'MI_F_3', code: 'MI_F_3', title: 'MI_F_3'},
{name: 'MI_Fs_3', code: 'MI_Fs_3', title: 'MI_Fs_3'},
{name: 'MI_G_3', code: 'MI_G_3', title: 'MI_G_3'},
{name: 'MI_Gs_3', code: 'MI_Gs_3', title: 'MI_Gs_3'},
{name: 'MI_A_3', code: 'MI_A_3', title: 'MI_A_3'},
{name: 'MI_As_3', code: 'MI_As_3', title: 'MI_As_3'},
{name: 'MI_B_3', code: 'MI_B_3', title: 'MI_B_3'},
{name: 'MI_C_4', code: 'MI_C_4', title: 'MI_C_4'},
{name: 'MI_Cs_4', code: 'MI_Cs_4', title: 'MI_Cs_4'},
{name: 'MI_D_4', code: 'MI_D_4', title: 'MI_D_4'},
{name: 'MI_Ds_4', code: 'MI_Ds_4', title: 'MI_Ds_4'},
{name: 'MI_E_4', code: 'MI_E_4', title: 'MI_E_4'},
{name: 'MI_F_4', code: 'MI_F_4', title: 'MI_F_4'},
{name: 'MI_Fs_4', code: 'MI_Fs_4', title: 'MI_Fs_4'},
{name: 'MI_G_4', code: 'MI_G_4', title: 'MI_G_4'},
{name: 'MI_Gs_4', code: 'MI_Gs_4', title: 'MI_Gs_4'},
{name: 'MI_A_4', code: 'MI_A_4', title: 'MI_A_4'},
{name: 'MI_As_4', code: 'MI_As_4', title: 'MI_As_4'},
{name: 'MI_B_4', code: 'MI_B_4', title: 'MI_B_4'},
{name: 'MI_C_5', code: 'MI_C_5', title: 'MI_C_5'},
{name: 'MI_Cs_5', code: 'MI_Cs_5', title: 'MI_Cs_5'},
{name: 'MI_D_5', code: 'MI_D_5', title: 'MI_D_5'},
{name: 'MI_Ds_5', code: 'MI_Ds_5', title: 'MI_Ds_5'},
{name: 'MI_E_5', code: 'MI_E_5', title: 'MI_E_5'},
{name: 'MI_F_5', code: 'MI_F_5', title: 'MI_F_5'},
{name: 'MI_Fs_5', code: 'MI_Fs_5', title: 'MI_Fs_5'},
{name: 'MI_G_5', code: 'MI_G_5', title: 'MI_G_5'},
{name: 'MI_Gs_5', code: 'MI_Gs_5', title: 'MI_Gs_5'},
{name: 'MI_A_5', code: 'MI_A_5', title: 'MI_A_5'},
{name: 'MI_As_5', code: 'MI_As_5', title: 'MI_As_5'},
{name: 'MI_B_5', code: 'MI_B_5', title: 'MI_B_5'},
{name: 'MI_OCT_N2', code: 'MI_OCT_N2', title: 'MI_OCT_N2'},
{name: 'MI_OCT_N1', code: 'MI_OCT_N1', title: 'MI_OCT_N1'},
{name: 'MI_OCT_0', code: 'MI_OCT_0', title: 'MI_OCT_0'},
{name: 'MI_OCT_1', code: 'MI_OCT_1', title: 'MI_OCT_1'},
{name: 'MI_OCT_2', code: 'MI_OCT_2', title: 'MI_OCT_2'},
{name: 'MI_OCT_3', code: 'MI_OCT_3', title: 'MI_OCT_3'},
{name: 'MI_OCT_4', code: 'MI_OCT_4', title: 'MI_OCT_4'},
{name: 'MI_OCT_5', code: 'MI_OCT_5', title: 'MI_OCT_5'},
{name: 'MI_OCT_6', code: 'MI_OCT_6', title: 'MI_OCT_6'},
{name: 'MI_OCT_7', code: 'MI_OCT_7', title: 'MI_OCT_7'},
{name: 'MI_OCTD', code: 'MI_OCTD', title: 'MI_OCTD'},
{name: 'MI_OCTU', code: 'MI_OCTU', title: 'MI_OCTU'},
{name: 'MI_TRNS_N6', code: 'MI_TRNS_N6', title: 'MI_TRNS_N6'},
{name: 'MI_TRNS_N5', code: 'MI_TRNS_N5', title: 'MI_TRNS_N5'},
{name: 'MI_TRNS_N4', code: 'MI_TRNS_N4', title: 'MI_TRNS_N4'},
{name: 'MI_TRNS_N3', code: 'MI_TRNS_N3', title: 'MI_TRNS_N3'},
{name: 'MI_TRNS_N2', code: 'MI_TRNS_N2', title: 'MI_TRNS_N2'},
{name: 'MI_TRNS_N1', code: 'MI_TRNS_N1', title: 'MI_TRNS_N1'},
{name: 'MI_TRNS_0', code: 'MI_TRNS_0', title: 'MI_TRNS_0'},
{name: 'MI_TRNS_1', code: 'MI_TRNS_1', title: 'MI_TRNS_1'},
{name: 'MI_TRNS_2', code: 'MI_TRNS_2', title: 'MI_TRNS_2'},
{name: 'MI_TRNS_3', code: 'MI_TRNS_3', title: 'MI_TRNS_3'},
{name: 'MI_TRNS_4', code: 'MI_TRNS_4', title: 'MI_TRNS_4'},
{name: 'MI_TRNS_5', code: 'MI_TRNS_5', title: 'MI_TRNS_5'},
{name: 'MI_TRNS_6', code: 'MI_TRNS_6', title: 'MI_TRNS_6'},
{name: 'MI_TRNSD', code: 'MI_TRNSD', title: 'MI_TRNSD'},
{name: 'MI_TRNSU', code: 'MI_TRNSU', title: 'MI_TRNSU'},
{name: 'MI_VEL_0', code: 'MI_VEL_0', title: 'MI_VEL_0'},
{name: 'MI_VEL_1', code: 'MI_VEL_1', title: 'MI_VEL_1'},
{name: 'MI_VEL_2', code: 'MI_VEL_2', title: 'MI_VEL_2'},
{name: 'MI_VEL_3', code: 'MI_VEL_3', title: 'MI_VEL_3'},
{name: 'MI_VEL_4', code: 'MI_VEL_4', title: 'MI_VEL_4'},
{name: 'MI_VEL_5', code: 'MI_VEL_5', title: 'MI_VEL_5'},
{name: 'MI_VEL_6', code: 'MI_VEL_6', title: 'MI_VEL_6'},
{name: 'MI_VEL_7', code: 'MI_VEL_7', title: 'MI_VEL_7'},
{name: 'MI_VEL_8', code: 'MI_VEL_8', title: 'MI_VEL_8'},
{name: 'MI_VEL_9', code: 'MI_VEL_9', title: 'MI_VEL_9'},
{name: 'MI_VEL_10', code: 'MI_VEL_10', title: 'MI_VEL_10'},
{name: 'MI_VELD', code: 'MI_VELD', title: 'MI_VELD'},
{name: 'MI_VELU', code: 'MI_VELU', title: 'MI_VELU'},
{name: 'MI_CH1', code: 'MI_CH1', title: 'MI_CH1'},
{name: 'MI_CH2', code: 'MI_CH2', title: 'MI_CH2'},
{name: 'MI_CH3', code: 'MI_CH3', title: 'MI_CH3'},
{name: 'MI_CH4', code: 'MI_CH4', title: 'MI_CH4'},
{name: 'MI_CH5', code: 'MI_CH5', title: 'MI_CH5'},
{name: 'MI_CH6', code: 'MI_CH6', title: 'MI_CH6'},
{name: 'MI_CH7', code: 'MI_CH7', title: 'MI_CH7'},
{name: 'MI_CH8', code: 'MI_CH8', title: 'MI_CH8'},
{name: 'MI_CH9', code: 'MI_CH9', title: 'MI_CH9'},
{name: 'MI_CH10', code: 'MI_CH10', title: 'MI_CH10'},
{name: 'MI_CH11', code: 'MI_CH11', title: 'MI_CH11'},
{name: 'MI_CH12', code: 'MI_CH12', title: 'MI_CH12'},
{name: 'MI_CH13', code: 'MI_CH13', title: 'MI_CH13'},
{name: 'MI_CH14', code: 'MI_CH14', title: 'MI_CH14'},
{name: 'MI_CH15', code: 'MI_CH15', title: 'MI_CH15'},
{name: 'MI_CH16', code: 'MI_CH16', title: 'MI_CH16'},
{name: 'MI_CHD', code: 'MI_CHD', title: 'MI_CHD'},
{name: 'MI_CHU', code: 'MI_CHU', title: 'MI_CHU'},
{name: 'MI_ALLOFF', code: 'MI_ALLOFF', title: 'MI_ALLOFF'},
{name: 'MI_SUST', code: 'MI_SUST', title: 'MI_SUST'},
{name: 'MI_PORT', code: 'MI_PORT', title: 'MI_PORT'},
{name: 'MI_SOST', code: 'MI_SOST', title: 'MI_SOST'},
{name: 'MI_SOFT', code: 'MI_SOFT', title: 'MI_SOFT'},
{name: 'MI_LEG', code: 'MI_LEG', title: 'MI_LEG'},
{name: 'MI_MOD', code: 'MI_MOD', title: 'MI_MOD'},
{name: 'MI_MODSD', code: 'MI_MODSD', title: 'MI_MODSD'},
{name: 'MI_MODSU', code: 'MI_MODSU', title: 'MI_MODSU'},
{name: 'MI_BENDD', code: 'MI_BENDD', title: 'MI_BENDD'},
{name: 'MI_BENDU', code: 'MI_BENDU', title: 'MI_BENDU'},
      ],
    },
    /*
